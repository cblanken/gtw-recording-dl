...
if __name__ == "__main__":
    if len(argv) != 3:
        print("Usage: python dl.py <GoToWebinar link> <output file>")
    else:
        page_url = str(argv[1])
        ...
        # TODO read creds from JSON file or from command line
        reg_info = {"firstName":"Cameron","lastName":"Blankenbuehler","email":"cameron.blankenbuehler@protonmail.com"}
